...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createCarousel = function (images = []) {
  for (let i = 0; i < this.length; i++) {
    this[i].innerHTML = `
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).carousel();
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  for (let i = 0; i < this.length; i++) {
    ...
    (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`${target} [data-close]`).click(() => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    for (let j = 0; j < btns.count; j++) {
      ...
      if (btns.settings[j][3] && typeof settings[j][3] === 'function') {
...
$.prototype.init = function (selector) {
  if (!selector) {
    return this; // возвращает пустой обьект
  }
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.fadeToggle = function (duration, display, final) {
  for (let i = 0; i < this.length; i++) {
    if (window.getComputedStyle(this[i]).display === 'none') {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).fadeIn(duration, display, final);
    } else {
      (0,_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).fadeOut(duration, final);
    }
  }
  return this;
};
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#carousel2').createCarousel([{
...
(0,_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])().get('https://jsonplaceholder.typicode.com/posts/1/comments').then(res => console.log(res));
})();
